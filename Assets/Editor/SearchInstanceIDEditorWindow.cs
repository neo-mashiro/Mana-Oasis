...
public class SearchInstanceIDEditorWindow : EditorWindow {
    ...
    private static void Init() {
        ...
        var window = (SearchInstanceIDEditorWindow) GetWindowWithRect(
            typeof(SearchInstanceIDEditorWindow), windowRect, false, "Search Window");
        window.Show();
    }
    ...
    private void OnGUI() {
        ...
        GUILayout.Space(20);
        _input = EditorGUILayout.TextField("Enter Instance ID", _input, new GUIStyle("SearchTextField"));
